...
public class ForumUsersController {
    ...
    public ForumUsersController(ForumUserService service, InterestService skillService, InterestRepository interestRepository, ForumUserRepository forumUserRepository) {
    ...
    public String showList(@RequestParam(required = false) Long interestId,
        ...
        List<Interest> interests= this.skillService.listAll();
    ...
    public String showAdd(Model model) {
        ...
        ForumUserType[] types = ForumUserType.values();
