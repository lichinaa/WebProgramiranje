...
import mk.ukim.finki.wp.kol2022.g2.selenium.AbstractPage;
import mk.ukim.finki.wp.kol2022.g2.selenium.AddOrEditForm;
import mk.ukim.finki.wp.kol2022.g2.selenium.ItemsPage;
import mk.ukim.finki.wp.kol2022.g2.selenium.LoginPage;
...
public class SeleniumScenarioTest {
    ...
    static {
        SubmissionHelper.exam = "wp-kol-2022-g2";
        SubmissionHelper.index = "203068";
    }
    ...
    public void test_list_20pt() {
        ...
        List<Student> entities = this.service.listAll();
    ...
    public void test_filter_service_5pt() {
        ...
        ExamAssert.assertEquals("by course", 4, this.service.filter(1L, null).size());
    ...
    public void test_create_mvc_10pt() throws Exception {
        ...
        List<Course> categories = this.courseService.listAll();
        List<Student> students = this.service.listAll();

        int itemNum = students.size();
        ...
        ExamAssert.assertEquals("Number of items", itemNum + 1, students.size());
    ...
    public void test_delete_mvc_5pt() throws Exception {
        ...
        MockHttpServletRequestBuilder deleteRequest = MockMvcRequestBuilders
                .post("/students/" + entities.get(itemNum - 1).getId() + "/delete");
    ...
    public void test_edit_mvc_10pt() throws Exception {
        ...
        ExamAssert.assertEquals("The updated entity course number is not as expected.", 3, entities.get(itemNum - 1).getCourses().size());
    ...
    public void test_security_urls_10pt() {
        ...
        List<Student> entities = this.service.listAll();
        String editUrl = "/students/" + entities.get(0).getId() + "/edit";
    ...
    private static String admin = "student.1@wp.finki.ukim.mk";
    private static String adminPassword = "emp1";
    private static String user = "student.2@wp.finki.ukim.mk";
    ...
    public static final String ADD_URL = "/students/add";
