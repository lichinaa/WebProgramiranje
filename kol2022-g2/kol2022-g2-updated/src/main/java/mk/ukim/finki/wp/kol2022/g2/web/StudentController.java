...
public class StudentController {
    ...
    public StudentController(StudentService service, CourseService courseService, StudentRepository studentRepository, CourseRepository courseRepository) {
     ...
     */
    @GetMapping({"/", "/students"})
    public String showList(@RequestParam(required = false) Long courseId, Integer yearsOfStudying, Model model) {
